...
export function storeTokenTransfer(src: TokenTransfer) {
    return (builder: Builder) => {
        ...
        b_0.storeBit(true).storeRef(src.forward_payload).asSlice()
    };
}
...
export function storeRouter$Data(src: Router$Data) {
    return (builder: Builder) => {
        ...
        b_1.storeInt(src.jettonFee, 257);
        if (src.load !== null && src.load !== undefined) { b_1.storeBit(true).storeInt(src.load, 257); } else { b_1.storeBit(false); }
        b_0.storeRef(b_1.endCell());
    };
}
...
export function loadRouter$Data(slice: Slice) {
    ...
    let _jettonFee = sc_1.loadIntBig(257);
    let _load = sc_1.loadBit() ? sc_1.loadIntBig(257) : null;
    return { $$type: 'Router$Data' as const, manager: _manager, factory: _factory, cashBack: _cashBack, refBonus: _refBonus, jettonFee: _jettonFee, load: _load };
}
...
function loadTupleRouter$Data(source: TupleReader) {
    ...
    let _refBonus = source.readBigNumber();
    let _jettonFee = source.readBigNumber();
    let _load = source.readBigNumberOpt();
    return { $$type: 'Router$Data' as const, manager: _manager, factory: _factory, cashBack: _cashBack, refBonus: _refBonus, jettonFee: _jettonFee, load: _load };
}
...
function storeTupleRouter$Data(source: Router$Data) {
    ...
    builder.writeNumber(source.refBonus);
    builder.writeNumber(source.jettonFee);
    builder.writeNumber(source.load);
    return builder.build();
}
...
async function JettonDefaultWallet_init(owner: Address, master: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const JettonDefaultWallet_types: ABIType[] = [
    ...
    {"name":"Router$Data","header":null,"fields":[{"name":"manager","type":{"kind":"simple","type":"address","optional":false}},{"name":"factory","type":{"kind":"simple","type":"address","optional":false}},{"name":"cashBack","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"refBonus","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"jettonFee","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"load","type":{"kind":"simple","type":"int","optional":true,"format":257}}]},
